  ...
  <div data-v-bc186c1a class="app-view-wrapper">
    ...
    <div data-v-172bb70c data-v-bc186c1a class="content app-view app-view-with-footer">
      ...
      <div data-v-172bb70c class="b1 ui-flex align-center justify-space-between">
        <div data-v-172bb70c class="cite">我的订单</div>
        <div data-v-172bb70c class="span ui-flex align-center">
          <a data-v-172bb70c href="###" class data-stat-id="a7eaff9f80200456">全部订单</a>
        </div>
      </div>
      <ul data-v-172bb70c class="b2 ui-flex align-center justify-space-between">
        <li data-v-172bb70c class="dfk">
          <a data-v-172bb70c href="###" class data-stat-id="511ab24289b98fe6">
            <div data-v-172bb70c class="icon"></div>
            <span data-v-172bb70c>待付款</span>
            <!---->
          </a>
        </li>
        <li data-v-172bb70c class="dah">
          <a data-v-172bb70c href="###" class data-stat-id="7ed7f427a4d20235">
            <div data-v-172bb70c class="icon"></div>
            <span data-v-172bb70c>已付款</span>
            <!---->
          </a>
        </li>
        <li data-v-172bb70c class="thx">
          <a data-v-172bb70c href="###" data-stat-id="497872313157d22e">
            <div data-v-172bb70c class="icon"></div>
            <span data-v-172bb70c>失效</span>
          </a>
        </li>
      </ul>
      <div data-v-172bb70c class="ui-line"></div>
      <ul data-v-172bb70c class="items">
        <li data-v-172bb70c class="i-member">
          <a data-v-172bb70c href="###" class data-stat-id="a8133610f1c901ef">
            <cite data-v-172bb70c>我的收藏</cite>
          </a>
        </li>
        <li data-v-172bb70c class="i-wallet">
          <a
            data-v-172bb70c
            href="###"
            class
      ...
      <div data-v-172bb70c class="ui-line"></div>
      <ul data-v-172bb70c class="items">
        <li data-v-172bb70c class="i-service">
          <a data-v-172bb70c href="###" class data-stat-id="e90b943993e0cce3">
            <cite data-v-172bb70c>我的收货地址</cite>
          </a>
        </li>
        <li data-v-172bb70c class="i-mihome">
          <a data-v-172bb70c href="###" class data-stat-id="f6b73f8a7216172d">
            <cite data-v-172bb70c>把笨土豆分享给朋友</cite>
          </a>
        </li>
      </ul>
      <div data-v-172bb70c class="ui-line"></div>
      <div data-v-172bb70c class="ui-line"></div>
      <ul data-v-172bb70c class="items">
        <li data-v-172bb70c class="i-setting">
          <a data-v-172bb70c href="###" class data-stat-id="36040021395921ae">
            <cite data-v-172bb70c>我的设置</cite>
          </a>
        </li>
      </ul>
      <div data-v-172bb70c class="ui-line"></div>
...
.app-view-wrapper {
  /* display: flex; */
  margin-top: 1.062963rem;
}
.content[data-v-172bb70c] {
...
.hd .img img[data-v-172bb70c] {
  width: auto;
  height: 100%;
  margin: 0 auto;
}

.hd .name[data-v-172bb70c] {
  color: #fff;
  font-size: 0.24rem;
  text-align: left;
}

.hd .account[data-v-172bb70c] {
...
.b1 .cite[data-v-172bb70c] {
  font-size: 0.28rem;
  padding: 0 0 0 0.32rem;
  color: rgba(0, 0, 0, 0.87);
}

.b1 .span[data-v-172bb70c],
.b1 a[data-v-172bb70c] {
  font-size: 0.24rem;
  color: rgba(0, 0, 0, 0.87);
}
...
.b2 li em[data-v-172bb70c] {
  ...
  left: 50%;
  right: auto;
  -webkit-transform: translate3d(0.1rem, -200%, 0);
  transform: translate3d(0.1rem, -200%, 0);
  font-style: normal;
}

.items[data-v-172bb70c] {
  background: #fff;
}

.items li[data-v-172bb70c] {
  position: relative;
  color: rgba(0, 0, 0, 0.54);
  background: url(/static/img/i-setting.fb9625b3f2.png) no-repeat 0.32rem;
...
.items li[data-v-172bb70c]:not(:first-child):before {
  content: "";
  position: absolute;
  left: 0;
  top: -2px;
...
.items li[data-v-172bb70c]:after {
  content: "";
  position: absolute;
  right: 5.12px;
  right: 0.32rem;
...
.items li.i-fcode[data-v-172bb70c] {
  background-image: url(data:image/png;base64,);
}

.items li.i-setting[data-v-172bb70c] {
  background-image: url(/static/img/i-setting.fb9625b3f2.png);
}

.items li > a[data-v-172bb70c] {
  display: block;
  padding-right: 0.56rem;
...
.items li > a cite[data-v-172bb70c] {
  font-size: 0.28rem;
  font-style: normal;
  color: rgba(0, 0, 0, 0.87);
}
